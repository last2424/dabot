                        ...
                        for j in range(len(list)):
                            ...
                            if (cursor.rowcount > 0):
                                ...
                                if(balance - c >= 0):
                                    ...
                                    for(id) in cursor:
                                        t_id = id
                                    href = '<a href="https://torimori.info/index.php?page=balance_info&id='+str(user_id2)+'">'+str(comments[i].user.username)+'</a>'
                                    ...
                                    cursor.execute(sql)
                                    href = '<a href="https://torimori.info/index.php?page=balance_info&id='+str(user_id1)+'">'+str(g)+'</a>'
